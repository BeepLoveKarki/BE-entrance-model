...
<?php 
  ...
  $fp=file_get_contents("shortques.txt");
  $fp1=file_get_contents("longques.txt");
  $fp3=file_get_contents("passage.txt");
  $a=explode("\n",$fp);
  $b=explode("\n",$fp1);
  $c=explode("\n",$fp3);
?>
...
<div class="content">
<form action="math.php" method="post" id="form">
<div class="hea">
...
{  
  ...
  if($d==4)
    {
     echo("<div><img src='apt1q.jpg' class='apt1q'/></div>");
     echo("<div><img src='apt1a.jpg' class='apt1a'/></div>");
    } 
  if($d==5)
    {
     echo("<div><img src='apt2q.jpg' class='apt2q'/></div>");
     echo("<div><img src='apt2a.jpg' class='apt2a'/></div>");
    } 
  for($j=$i+1;$j<$i+9;$j+=2)
    {
      $k=$j+1;
